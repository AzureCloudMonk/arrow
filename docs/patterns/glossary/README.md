...
```kotlin
String.eq()
// arrow.instances.StringKt$eq$1@468ac4ab
```

```kotlin
Option.functor()
// arrow.instances.option.functor.OptionFunctorInstanceKt$functor$1@18f27817
```
...
// arrow.instances.mapk.semigroup.MapKSemigroupInstanceKt$semigroup$1@6689306
```

```kotlin
Either.monadError<Throwable>()
// arrow.instances.either.monadError.EitherMonadErrorInstanceKt$monadError$1@279ffa80
```

```kotlin
ListK.traverse()
// arrow.instances.listk.traverse.ListKTraverseInstanceKt$traverse$2@2c0b23e7
```
...
ListK.functor()
// arrow.instances.listk.functor.ListKFunctorInstanceKt$functor$1@3533ef06
```
